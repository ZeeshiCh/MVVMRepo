...
export default function ScanUltrasound() {
    const navigation = useNavigation();

    const handlePress = () => {
        NavigationService.navigate(ScreenNames.ScanUltrasoundManually);
    };
    return (
        <View style={styles.container}>
            ...
            <Button
                ...
                textColor="white"
                onPress={() => NavigationService.navigate(ScreenNames.UltrasoundReport)}
            />
            <Button
